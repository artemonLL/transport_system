...
/**
 * Testing the main methods of StationsService.
 * */
...
public class StationsServiceTests {
    ...
    /**
     * Testing first time the addStation method from StationService
     * use mock "stationDao".
     * */
    @Test
    public void testStationAdd() {
        ...
        logr.info("TEST ADD 1 IS end with =" + isAdd);
        Assert.assertTrue(" Add Train  first time-" + isAdd, isAdd);
    }
    /**
     * Testing second time the addStation method from StationService
     * use mock "stationDao".
     * */
    @Test
    ...
    /**
     * Testing getStation method from StationService
     * use mock "stationDao".
     * */
    @Test
