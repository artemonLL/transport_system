...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.11/jquery.datetimepicker.css">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand"  href="<c:url value="/" />">German Railways</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
           ...
           <a  class="nav-link" onclick="document.forms['logoutForm'].submit()">Logout</a>
                ...
                <c:if test="${pageContext.request.userPrincipal.name == null}">
                    ...
                    <li id="onhoverr" class="nav-item" >
                        <a  class="nav-link" style="white-space: nowrap;" href="<c:url value="/login" />">Sign In</a>
                    </li>
                </c:if>
